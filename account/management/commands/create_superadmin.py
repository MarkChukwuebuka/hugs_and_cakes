...
from utils.util import generate_random_username
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--username", type=str, help="Username of admin", default=generate_random_username())
        parser.add_argument("--email", type=str, help="Email of admin")
