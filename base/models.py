...
class ActiveAvailableManager(models.Manager):
    ...
    def get_queryset(self):
        return super(ActiveAvailableManager, self).get_queryset().filter(is_active=True, is_deleted=False)
...
class BaseModel(models.Model):
    ...
    deleted_by = models.ForeignKey("account.User", null=True, blank=True, on_delete=models.SET_NULL, related_name="+")
